...
var Channel = function () {
    ...
    _createClass(Channel, [{
        ...
        value: function find(q) {
            ...
            console.log(q);
            return new Promise(function (resolve, reject) {
                _this2.app.db.db("mongodbmessenger").collection('channels').find(q, options).toArray(function (err, results) {
                    return err ? reject(err) : resolve(results);
                });
            });
        }
        ...
        value: function findById(id) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this4.app.db.db("mongodbmessenger").collection('channels').findOne({ _id: new _mongodb.ObjectID(id) }, function (err, result) {
        ...
        value: function create(obj) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var db = _this5.app.db;
                db.db("mongodbmessenger").collection('channels').insertOne(channel, function (err, info) {
                    if (!err) {
                        var channelId = channel._id.toString();
                        _this5.channels = _this5.channels.set();
                    }
